...
class RestaurantRegistrationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "logo_url": forms.URLInput(attrs={"class": "form-control", "placeholder": "Or Paste Web Logo URL (https://...)"}),
            "cover_image": forms.ClearableFileInput(attrs={"class": "form-control", "accept": "image/*"}),
            "cover_image_url": forms.URLInput(attrs={"class": "form-control", "placeholder": "Or Paste Web Cover Banner URL (https://...)"}),
